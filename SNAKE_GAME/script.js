...
const changeDirection = e => {
    // Prevent default arrow key scrolling (only if preventDefault exists - i.e., real keyboard event)
    ...
    // Changing velocity value based on key press (Arrow keys)
    ...
    // WASD keys
    else if ((e.key === "w" || e.key === "W") && velocityY != 1) {
        velocityX = 0;
        velocityY = -1;
    } else if ((e.key === "s" || e.key === "S") && velocityY != -1) {
        velocityX = 0;
        velocityY = 1;
    } else if ((e.key === "a" || e.key === "A") && velocityX != 1) {
        velocityX = -1;
        velocityY = 0;
    } else if ((e.key === "d" || e.key === "D") && velocityX != -1) {
        velocityX = 1;
        velocityY = 0;
    }
}
...
document.addEventListener("keydown", (e) => {
    ...
    // Handle start/restart with Space key
